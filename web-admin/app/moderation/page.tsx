        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2 text-xs">
              ...
              <span className="px-2 py-1 bg-yellow-100 text-yellow-700 rounded">{stats.pending} pending</span>
              <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded">{stats.reviewed} reviewed</span>
              <span className="px-2 py-1 bg-green-100 text-green-700 rounded">{stats.resolved} resolved</span>
            </div>
          </div>
          <button
            onClick={loadReports}
