...
CREATE INDEX IF NOT EXISTS idx_notifications_unread ON notifications(user_id, is_read) WHERE is_read = false;-- Part 5: Row Level Security Policies
...
CREATE POLICY "System can manage subscriptions" ON subscriptions
    FOR ALL USING (auth.uid() = user_id);-- Part 6: Functions and Triggers
-- Execute this last
